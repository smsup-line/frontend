...
if (typeof process !== 'undefined' && process.env.NEXT_RUNTIME === 'nodejs') {
  ...
  // Do not wrap vm.runInContext. Next.js 16 loads middleware/edge runtime
  // through it, and substring checks like "sh" / "nc" / "kill" false-positive
  // on normal framework code (e.g. Object.defineProperty(self, '__listeners')).
