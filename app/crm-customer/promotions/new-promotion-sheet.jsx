...
export function NewPromotionSheet({ open, onOpenChange, onSuccess }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.custom(
        (t) => (
          <Alert variant="mono" icon="primary" onClose={() => toast.dismiss(t)}>
            ...
            <AlertTitle>เพิ่มโปรโมชั่นสำเร็จ</AlertTitle>
          </Alert>
        ),
        {
          position: 'top-center',
      ...
      toast.error(error.message || 'ไม่สามารถเพิ่มโปรโมชั่นได้');
    } finally {
      setUploading(false);
    }
  };
