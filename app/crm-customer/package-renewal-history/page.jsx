...
import PackageRenewalHistoryList from './package-renewal-history-list';
import { PageHeader } from './page-header';
import { ScreenLoader } from '@/components/screen-loader';

export default function PackageRenewalHistoryPage() {
  ...
  return (
    <>
      ...
      <Content className="block py-0">
        <PackageRenewalHistoryList refreshKey={refreshKey} />
      </Content>
    </>
  );
}
